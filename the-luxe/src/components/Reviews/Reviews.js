      ...
      <Container fluid>
        ...
        <Carousel data-bs-theme="dark" indicators={false}>
          <Carousel.Item className="cons">
            <p className="p">
              Beautifully furnished rooms, top-tier amenities, and an
              outstanding restaurant. The staff made our stay memorable with
              their warmth and professionalism.
            </p>
          ...
          <Carousel.Item className="cons">
            <p className="p">
              ...
              rooms were elegantly designed, and the view was breathtaking.
            </p>
            <div> {renderStarIcons()} </div>
          ...
          <Carousel.Item className="cons">
            <p className="p">
              The attention to detail at this hotel is unmatched. The spa,
              dining, and service were impeccable. Every corner of the hotel
              exudes elegance.
            </p>
            <div> {renderStarIcons()} </div>
